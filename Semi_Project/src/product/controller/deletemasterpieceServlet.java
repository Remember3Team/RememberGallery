...
/**
 * Servlet implementation class deletemasterpieceServlet
 */
@WebServlet("/deletetmasterpiece.po")
public class deletemasterpieceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public deletemasterpieceServlet() {
        super();
