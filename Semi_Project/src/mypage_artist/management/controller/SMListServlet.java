...
/**
 * Servlet implementation class SMListServlet
 */
@WebServlet("/SM.list")
public class SMListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SMListServlet() {
        super();
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 페이지 수 처리용 변수 선언
				...
				// 1_2. 게시판 리스트 조회해오기
				ArrayList<Mypage_artist> SM_list = aService.selectList_SM(currentPage, limit, bWriter);
