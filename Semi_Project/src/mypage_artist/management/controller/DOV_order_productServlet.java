...
/**
 * Servlet implementation class DOV_order_productServlet
 */
@WebServlet("/DOV.OP")
public class DOV_order_productServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DOV_order_productServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 1_1. 게시판 리스트 갯수 구하기
				...
				// 1_2. 게시판 리스트 조회해오기
				ArrayList<Mypage_artist> DOV_OP = aService.detail_order_view(bWriter);
...
//				}
				...
				if(!DOV_OP.isEmpty()) {
					...
					request.setAttribute("DOV_OP", DOV_OP);
				}else {
