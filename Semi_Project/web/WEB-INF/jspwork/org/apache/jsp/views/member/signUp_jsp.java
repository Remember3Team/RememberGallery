...
<<<<<<< HEAD
<<<<<<< HEAD
 * Generated at: 2020-05-23 19:32:22 UTC
=======
 * Generated at: 2020-05-23 19:15:25 UTC
=======
 * Generated at: 2020-05-23 19:34:27 UTC
=======
 * Generated at: 2020-05-24 12:44:08 UTC
...
<<<<<<< HEAD
<<<<<<< HEAD
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1590257743721L));
    _jspx_dependants.put("/views/member/../common/footer.jsp", Long.valueOf(1590116110993L));
=======
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1590260942790L));
=======
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1590262015023L));
    _jspx_dependants.put("/views/member/../common/footer.jsp", Long.valueOf(1590116113589L));
=======
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1590321412202L));
>>>>>>> refs/remotes/origin/master
...
if(loginUser != null){ 
      ...
      out.write("\t\t\t\t\t\t\tclass=\"nomal-text\" type=\"text\" id=\"userName\" name=\"userName\" placeholder=\"NAME\"\r\n");
      out.write("\t\t\t\t\t\t\trequired>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<br>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\tstyle=\"width: 280px; height: 30px; color: white; background: #cc0000\" onclick=\"checkId()\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("<script>\r\n");
      out.write("\t\r\n");
      out.write("\t//아이디 중복확인 버튼 check 때문에 서브밋 버튼을 버튼으로 만들고, function을 통해 서브밋을  하게됨.\r\n");
      out.write("\t//그렇게 되면 required 기능이 제공되지 않음\r\n");
      out.write("\t//required 기능을 하게 하기 위한 if~else문 적용\r\n");
      out.write("\tfunction checkId(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif($(\"#userName\").val()==\"\"){\r\n");
      out.write("\t\t\talert(\"이름을 안쓰다니...\");\r\n");
      out.write("\t\t}else{\t// 이름은 썼느데\r\n");
      out.write("\t\t\tif($(\"#userId\").val()==\"\"){\r\n");
      out.write("\t\t\t\talert(\"중요한 아이디를 안쓰다니!\");\t\t\t\t\r\n");
      out.write("\t\t\t}else{ // 아이디는 썼는데\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif($(\"#userPwd\").val().length>=6 && $(\"#userPwd2\").val().length>=6){\r\n");
      out.write("\t\t\t\t\t\tif($(\"#nickName\").val()==\"\"){\r\n");
      out.write("\t\t\t\t\t\t\talert(\"닉네임은 써도 되고 안써도 되지만 안쓰면 안넘어가요 ㅎㅎ\");\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tif($(\"#phone\").val()==\"\"){\r\n");
      out.write("\t\t\t\t\t\t\t\talert(\"번호를 입력하세요\");\r\n");
      out.write("\t\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t\tif($(\"#email\").val()==\"\"){\r\n");
      out.write("\t\t\t\t\t\t\t\t\talert(\"이메일을 입력하세요.\");\r\n");
      out.write("\t\t\t\t\t\t\t\t}else{// 이메일을 썼으면\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif(!emailJ.test($(\"#email\").val())){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\talert(\"이메일 형식으로 써주세요.\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}else{ //정큐표현식에 맞으면\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t //아이디 중복 확인\r\n");
      ...
      out.write("\t \t\t\t$(\"#idCheck\").css(\"background-color\",\"red\");\t\r\n");
      out.write("\t \t\t});\r\n");
