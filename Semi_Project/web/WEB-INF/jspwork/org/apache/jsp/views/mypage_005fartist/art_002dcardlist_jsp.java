 ...
 * Generated at: 2020-05-23 12:58:32 UTC
...
public final class art_002dcardlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/mypage_artist/../common/menubar.jsp", Long.valueOf(1590217384000L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	int endPage = pi.getEndPage();
      ...
      out.write("<title>감동 카드 확인하기</title>\n");
...
/*     Apply aphoto = (Apply)request.getAttribute("aphoto"); */
      ...
      out.write("            <div class=\"table-headline\" style=\"margin-top: 50px;\">\n");
      out.write("                <!-- <div><span>카드 내역</span></div> -->\n");
      out.write("                <div class=\"button\"><button class=\"btn btn-outline-dark\" style = \"width:120px;margin-bottom: 15px;\" onclick=\"deleteCard()\" >선택 삭제</button></div>\n");
      out.write("            </div>\n");
      out.write("            <table style=\"width:100%; font-size:14px\" name=\"card-list\">\n");
      out.write("                <tr>\n");
      ...
      out.write("                    <th style = \"text-align : center;\">구매자 이름</th>\n");
      out.write("                    <th style = \"text-align : center;\">감동 카드</th>\n");
      out.write("                </tr>\n");
      out.write("                \n");
      out.write("                ");
 for(int i = 0 ; i < mlist.size(); i++){
      ...
      out.write("\n");
      out.write("                <tr>\n");
      out.write("                    <td><input class = \"check_sub\" type=\"checkbox\" name = \"check\" value=\"");
      out.print(m.getOrder_no());
      out.write("\"></td>\n");
      out.write("                    <td>");
      out.print(m.getPaint_no());
      out.write("</td>\n");
      out.write("                    <td>\n");
      out.write("\t\t\t\t\t ");
 ...
 if(m.getPaint_no() == a.getPaint_no()) { 
      ...
      out.write("\t\t\t\t\t</td>\n");
      out.write("                    <td>작품명 : ");
      out.print(m.getPaint_name());
      out.write("</td>\n");
      out.write("                    <td>");
      out.print(m.getUser_name());
      out.write("</td>\n");
      out.write("                    <td><textarea class = \"question-area\" readonly=\"readonly\" style =\"border-style:none; border-radius : 5px;\n");
      out.write("       \t\t\t\tpadding : 10px; width : 320px; background:rgb(241, 241, 241); resize:none;\">");
      ...
      out.write("            \n");
      out.write("            if(chk) $(\".check_sub\").prop('checked', true);\n");
      out.write("            \n");
      out.write("            else  $(\".check_sub\").prop('checked', false);\n");
      out.write("        });\n");
      out.write("    });\n");
      out.write("\n");
      out.write("    \n");
      ...
      out.write("    \n");
      out.write("    \n");
      out.write("    // 하나도 체크가 안 됐을 경우\n");
      out.write("    if (arrayList == ''){\n");
      out.write("    \talert(\"한 가지 이상을 선택해 주세요.\");\n");
      out.write("    } else {\n");
      out.write("    \tif(!confirm(\"삭제하시겠습니까? 한번 삭제시 복구할 수 없습니다.\"))\n");
...
if(currentPage == p){ 
      out.write("\n");
      out.write("              <li class = \"page-list1\">\n");
      out.write("              \t<button disabled class = \"page-cur\" >");
      out.print(p);
      out.write("</button>\n");
      out.write("              </li>\n");
      out.write("            ");
