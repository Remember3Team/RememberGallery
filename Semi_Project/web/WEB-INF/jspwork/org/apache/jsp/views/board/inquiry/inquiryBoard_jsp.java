 ...
 * Generated at: 2020-05-26 04:21:27 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.views.board.inquiry;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;
import board.inquiry.model.vo.*;
...
public final class inquiryBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/inquiry/../../common/footer.jsp", Long.valueOf(1590116247884L));
    _jspx_dependants.put("/views/board/inquiry/../../common/menubar.jsp", Long.valueOf(1590332147839L));
  }
  ...
  static {
    ...
    _jspx_imports_packages.add("board.inquiry.model.vo");
...
int endPage = pi.getEndPage();
      ...
      out.write("</head>\r\n");
      out.write("<style>\r\n");
      out.write("\t#centerDiv{margin-top:70px;}\r\n");
...
if(loginUser != null){ 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<!-- 1:1 게시판 Logo -->\r\n");
      out.write("<div class=\"headLine\">\r\n");
      out.write("\t\t<hr style=\"display:inline-block;\">\r\n");
      out.write("\t\t<h3 style=\"font-size:20px;\">1:1문의</h3>\r\n");
      out.write("</div><!-- class headLine end -->\r\n");
      out.write("<br clear=\"both\">\r\n");
      out.write("\r\n");
      out.write("<div id=\"centerDiv\" class=\"container\" >\r\n");
      out.write("<!-- 사용자에게는 보이고 관리자에게 보이지 않는 페이지 div id addQuestionArea -->\t\t\t\r\n");
      out.write(" <div id=\"addQuestionArea\" class=\"form-group\">\r\n");
      ...
      out.write("        \t<option value=\"배송\">배송문의</option>\r\n");
      out.write("        \t<option value=\"환불\">환불문의</option>\r\n");
      out.write("        \t<option value=\"사이트오류\">사이트 이용문의</option>\r\n");
      out.write("        \t<option value=\"기타\">기타문의</option>\r\n");
      out.write("      \t  </select>\r\n");
      out.write("    </div>\r\n");
      out.write("    <div class=\"form-group col-md-9\">\r\n");
      out.write("      <input type=\"text\" class=\"form-control\" id=\"question_title\" name=\"question_title\" placeholder=\"게시글 제목은 모든 사용자에게 노출됩니다.\">\r\n");
      out.write("    </div>\r\n");
      out.write("  </div>\r\n");
      out.write("  <div class=\"form-row\">\r\n");
      out.write("  \t<div class=\"form-group col-md-11\">\r\n");
      out.write("  \t\t<textarea class=\"form-control\" id=\"question\" name=\"question\" rows=\"5\" placeholder=\"문의 내용을 입력해주세요\"></textarea>\r\n");
      out.write("    </div>\r\n");
      out.write("    <div class=\"form-group col-md-1\">\r\n");
      out.write("\t    <button id=\"addQuestion\" class=\"btn btn-danger\" style=\"height:130px\">문의하기</button>  \t\t\r\n");
      out.write("    </div>\r\n");
      out.write("  </div>\r\n");
      out.write("  </div><!-- div id addQuestionArea end -->\r\n");
      out.write("  \r\n");
      out.write(" \r\n");
      out.write(" <script>\r\n");
      out.write(" \twindow.onload = function(){\r\n");
      out.write(" \t\t//로그인 유저에 따라 입력 창 display none block 여부 확인\r\n");
      out.write(" \t\tif(\"");
      out.print(loginUser.getUserId());
      out.write("\"==\"admin\"){\r\n");
      out.write("\t \t\tdocument.getElementById(\"addQuestionArea\").style.display=\"none\";\t\t\r\n");
      out.write(" \t\t}\r\n");
      out.write(" \t}\r\n");
      out.write(" </script>\r\n");
      out.write(" <br><br><br><br>\r\n");
      out.write("<table class=\"table\" id=\"inquiryList\">\r\n");
      out.write("  <thead>\r\n");
      out.write("    <tr>\r\n");
      out.write("      <th scope=\"col\" class=\"text-center\">문의구분</th>\r\n");
      out.write("      <th scope=\"col\" class=\"text-center\">문의내용</th>\r\n");
...
if(loginUser.getUserId().equals("admin")){ 
      ...
      out.write("      \r\n");
      out.write("      \t<th scope=\"col\" class=\"text-center\">답변 여부</th>\r\n");
      out.write("      ");
} 
      out.write("\r\n");
      out.write("    </tr>\r\n");
      out.write("  </thead>\r\n");
      out.write("  <tbody id=\"showInquiry\">\r\n");
      out.write("  ");
 if(list.isEmpty()){
      out.write("\r\n");
      out.write("  ");
...
for(Inquiry in :list){
      ...
      out.print(in.getQ_no() );
      out.write("\">\r\n");
      out.write("      <th scope=\"row\" class=\"text-center\">");
      out.print(in.getQ_cate() );
      out.write("</th>\r\n");
      out.write("      <td class=\"text-center\">");
      out.print(in.getQuestion_title() );
      out.write("</td>\r\n");
      out.write("      <td class=\"text-center\">");
      out.print(in.getUser_id() );
      out.write("</td>\r\n");
      out.write("      ");
if(loginUser.getUserId().equals("admin") && in.getQ_yn().equals("N")){ 
      out.write("\r\n");
      out.write("      \t<td class=\"text-center\"><button id=\"inputAnswer\" class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#intro\">답변하기</button>\r\n");
      out.write("      ");
}else{ 
      out.write("\r\n");
      out.write("      \t<td class=\"text-center\">");
      out.print(in.getQ_yn() );
      out.write("</td>\r\n");
      out.write("      ");
} 
      out.write("\r\n");
...
if(loginUser.getUserId().equals("admin") || loginUser.getUserId().equals(in.getUser_id())){ 
      ...
      out.write("\t\t<td class=\"text-center\">문의 내용</td>\r\n");
      out.write("\t\t<td class=\"text-center\" colspan=\"4\"><span>");
      out.print(in.getQuestion() );
      out.write("</span></textarea></td>\r\n");
      out.write("\t\t\r\n");
      out.write("    </tr>\r\n");
      out.write("    ");
} 
      ...
      out.write("      \r\n");
      out.write("<!-- 모달  --> \r\n");
      out.write("        <div class=\"modal fade\" id=\"intro\" role=\"dialog\" aria-labelledby=\"introHeader\" aria-hidden=\"true\" tabindex=\"-1\">\r\n");
      out.write("            <div class=\"modal-dialog\">\r\n");
      out.write("                <div class=\"modal-content\">\r\n");
      out.write("                    <div class=\"modal-header\">\r\n");
      out.write("                        <h4 class=\"modal-title\">답변 입력</h4>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <form action=\"answer.in\" method=\"get\">\r\n");
      out.write("\t                    <div class=\"modal-body\">\r\n");
      out.write("\t                        <textarea id=\"answerArea\" name=\"answerArea\" cols=\"80\" row=\"30\"></textarea>\r\n");
      out.write("\t                    </div>\r\n");
      ...
      out.write("\t<div class = \"p-parents\" style=\"margin:0 auto; margin-top:80px;\">\r\n");
...
if (currentPage == maxPage) { 
      ...
      out.print(loginUser.getUserId());
      out.write("\";\r\n");
      out.write("\t\t\tvar q_cate = $(\"#Category\").val();\r\n");
      out.write(" \t\t\tvar question_title = $(\"#question_title\").val();\r\n");
      out.write(" \t\t\tvar question = $(\"#question\").val();\r\n");
      out.write(" \t\t\t\r\n");
      out.write(" \t\t\t$.ajax({\r\n");
      out.write(" \t\t\t\turl:\"insert.in\",\r\n");
      out.write(" \t\t\t\ttype:\"post\",\r\n");
      out.write(" \t\t\t\tdata:{writer:writer,q_cate:q_cate,question_title:question_title,question:question},\r\n");
      out.write(" \t\t\t\tsuccess:function(data){\r\n");
      out.write(" \t\t\t\t\t$inquiryTable = $(\"#showInquiry\");\r\n");
      out.write(" \t\t\t\t\t$inquiryTable.html(\"\");\r\n");
      out.write(" \t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\tfor(var key in data){\r\n");
      out.write("\t\t\t\t\t\t \t\t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t\tvar $tr = $(\"<tr>\");\r\n");
      out.write(" \t\t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t\tvar $writerTd=$(\"<td>\").text(data[key].user_id).addClass('text-center');\r\n");
      out.write(" \t\t\t\t\t\tvar $categoryTd=$(\"<td>\").text(data[key].q_cate).addClass('text-center');\r\n");
      out.write(" \t\t\t\t\t\tvar $question_titleTd=$(\"<td>\").text(data[key].question_title).addClass('text-center');\r\n");
      out.write(" \t\t\t\t\t\tvar $questionTd=$(\"<td>\").text(data[key].question).addClass('text-center');\r\n");
      out.write(" \t\t\t\t\t\tvar $questionYnTd=$(\"<td>\").text(data[key].q_yn).addClass('text-center');\r\n");
      out.write(" \t\t\t\t\t\tvar $questionFileTd=$(\"<td>\").text(data[key].q_file).addClass('text-center');\r\n");
      out.write(" \t\t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t\t$tr.append($categoryTd);\r\n");
      out.write(" \t\t\t\t\t\t$tr.append($question_titleTd);\r\n");
      out.write(" \t\t\t\t\t\t$tr.append($writerTd);\r\n");
      out.write(" \t\t\t\t\t\t$tr.append($questionYnTd);\r\n");
      out.write("\r\n");
      out.write(" \t\t\t\t\t\t$tr.append($questionTd);\r\n");
      out.write(" \t\t\t\t\t\t$tr.append($questionFileTd);\r\n");
      out.write("\r\n");
      out.write(" \t\t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t\t$inquiryTable.append($tr);\r\n");
      out.write(" \t\t\t\t\t}\r\n");
      out.write(" \t\t\t\t\t$(\"#question_title\").val(\"\");\r\n");
 ...
 * Version: Apache Tomcat/8.5.54
<<<<<<< HEAD
 * Generated at: 2020-05-25 06:25:26 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
...
public final class inquiryBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    _jspx_dependants = new java.util.HashMap<java.lang.String,java.lang.Long>(2);
    _jspx_dependants.put("/views/board/inquiry/../../common/footer.jsp", Long.valueOf(1590116166200L));
    _jspx_dependants.put("/views/board/inquiry/../../common/menubar.jsp", Long.valueOf(1590321412202L));
=======
 * Generated at: 2020-05-25 06:42:00 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
...
public final class inquiryBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    _jspx_dependants = new java.util.HashMap<java.lang.String,java.lang.Long>(2);
    _jspx_dependants.put("/views/board/inquiry/../../common/footer.jsp", Long.valueOf(1590116113589L));
    _jspx_dependants.put("/views/board/inquiry/../../common/menubar.jsp", Long.valueOf(1590337672900L));
...
int endPage = pi.getEndPage();
      ...
      out.write("<head>\n");
      out.write("<meta charset=\"UTF-8\">\n");
      out.write("<title>1:1문 - RememberArt</title>\n");
      out.write("<link rel=\"stylesheet\" href=\"");
      out.print(request.getContextPath() );
      out.write("/views/css/style.css\">\n");
      out.write(" <link href=\"https://fonts.googleapis.com/css2?family=Roboto&display=swap\" rel=\"stylesheet\">\n");
...
if(loginUser != null){ 
      ...
      out.write("<div id=\"centerDiv\" class=\"container\" >\n");
      out.write("<!-- 사용자에게는 보이고 관리자에게 보이지 않는 페이지 div id addQuestionArea -->\t\t\t\n");
      out.write(" <div id=\"addQuestionArea\">\n");
      out.write("  <div class=\"form-row\">\n");
      out.write("    <div class=\"form-group col-md-3\">\n");
      out.write("      \t<select id=\"Category\" class=\"form-control\">\n");
      out.write("       \t \t<option selected>선택</option>\n");
      ...
      out.write("    </div>\n");
      out.write("    <div class=\"form-group col-md-1\">\n");
      out.write("\t    <button id=\"addQuestion\" class=\"btn btn-primary\" style=\"height:130px\">문의하기</button>  \t\t\n");
      out.write("    </div>\n");
      out.write("    \n");
      out.write("  </div>\n");
      out.write("  </div><!-- div id addQuestionArea end -->\n");
...
if(loginUser.getUserId().equals("admin") && in.getQ_yn().equals("N")){ 
      out.write("\n");
      out.write("      \t<td class=\"text-center\"><button id=\"inputAnswer\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#intro\">답변하기</button>\n");
      out.write("      ");
}else{ 
      out.write("\n");
      out.write("      \t<td class=\"text-center\">");
...
if(loginUser.getUserId().equals("admin") || loginUser.getUserId().equals(in.getUser_id())){ 
      ...
      out.print(request.getContextPath());
      out.write("/list.in?currentPage=1\">Previous</a></li>\n");
      out.write("\t  \t\t\t\t\t");
for(int p = startPage; p<=endPage; p++){ 
      out.write("\n");
      out.write("\t  \t\t\t\t\t \t<li class=\"page-item\"><a class=\"page-link\" href=\"");
      out.print(request.getContextPath() );
      out.write("/list.in?currentPage=");
      out.print(p);
      out.write('"');
      out.write('>');
      out.print(p);
