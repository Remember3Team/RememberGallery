 ...
 * Generated at: 2020-05-27 01:38:19 UTC
...
public final class inquiryBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/inquiry/../../common/menubar.jsp", Long.valueOf(1590509823365L));
  }
...
if(loginUser != null){ 
      ...
      out.print(loginUser);
      out.write("\"=null){\r\n");
      out.write(" \t\t\talert(\"로그인 한 회원만 이용 가능합니다.\");\r\n");
      out.write(" \t\t}\r\n");
      out.write(" \t\tif(\"");
...
if(loginUser.getUserId().equals("admin") || loginUser.getUserId().equals(in.getUser_id())){ 
      ...
      out.write("\t                        <textarea id=\"answerArea\" name=\"answerArea\" cols=\"55\" row=\"30\"></textarea>\r\n");
      out.write("\t                    </div>\r\n");
