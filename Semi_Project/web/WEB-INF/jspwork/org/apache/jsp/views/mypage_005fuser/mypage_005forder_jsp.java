...
<<<<<<< HEAD
 * Generated at: 2020-05-26 16:13:36 UTC
=======
 * Generated at: 2020-05-26 09:01:48 UTC
...
<<<<<<< HEAD
    _jspx_dependants.put("/views/mypage_user/../common/mypagehead2.jsp", Long.valueOf(1590258627303L));
    _jspx_dependants.put("/views/mypage_user/../common/menubar.jsp", Long.valueOf(1590492040591L));
...
=======
    ...
    _jspx_dependants.put("/views/mypage_user/../common/menubar.jsp", Long.valueOf(1590477602405L));
    _jspx_dependants.put("/views/mypage_user/../common/footer.jsp", Long.valueOf(1590116110993L));
>>>>>>> refs/remotes/origin/master
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    int endPage = pi.getEndPage();
      ...
      out.write("\t\tvar searchStatus = this.value;\r\n");
      out.write("\t\t $(\"#searchStatus\").val(searchStatus);\r\n");
      out.write("// \t\tconsole.log(searchStatus);\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"input[name=term]:radio\").click(function(){\r\n");
      out.write("\t\tterm = this.value;\r\n");
      out.write("\t\tconsole.log(term);\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      ...
      out.write("// \t\tconsole.log(searchStatus);\r\n");
      out.write("// \t});\r\n");
      out.write("// \tvar searchStatus = $(\"#searchStatus\").val();\r\n");
      out.write("\t\r\n");
      out.write("// \tconsole.log(searchStatus);\r\n");
      out.write("// \tvar term = $(\"input[name=term]:radio:checked\").val();\r\n");
      out.write("// \tvar calendar = $(\"#calendar\").val();\r\n");
      out.write("// \tvar calendar2 = $(\"#calendar2\").val();\r\n");
      out.write("\t\r\n");
      out.write("// \tvar data = {\r\n");
      out.write("// \t    \t\t'search_status' : searchStatus,\r\n");
      out.write("// \t    \t\t'term' : term,\r\n");
      out.write("// \t    \t\t'calendar' : calendar,\r\n");
      out.write("// \t    \t\t'calendar2' : calendar2\r\n");
      out.write("// \t    \t };\r\n");
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t   \r\n");
      out.write("\t\t   var order_no = gOrderNo;\r\n");
      out.write("\t\t   var paint_name = gPaintName;\r\n");
      out.write("\t\t   var artist_name = gArtistName;\r\n");
      out.write("\t\t   var paint_no = gPaintNo;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t   \r\n");
      out.write("\t\t   // input hidden태그에 보조 정보들 넣기\r\n");
      out.write("\t\t   $(\"#modal_order_no\").val(order_no);\r\n");
      out.write("\t\t   $(\"#modal_paint_name\").val(paint_name );\r\n");
      out.write("\t\t   $(\"#modal_artist_name\").val(artist_name);\r\n");
      out.write("\t\t   $(\"#modal_paint_no\").val(paint_no);\r\n");
      out.write("\t\t   \r\n");
      out.write("\t\t   $(\"#modal_img\").css('background-image', 'url(\\''+$(\"#img_\"+order_no).val()+'\\')');\r\n");
      out.write("\t\t   $(\"#modal_title\").html(paint_name+\" 작가님에게<br/>메시지를 남겨보세요.\");\r\n");
      out.write("\t\t   \r\n");
      ...
      out.write("\t    var orderNo = $(\"#modal_order_no\").val();\r\n");
      out.write("\t    var paintNo = $(\"#modal_paint_no\").val();\r\n");
      out.write("\t    var paintName = $(\"#modal_paint_name\").val();\r\n");
      out.write("\t    var artistName =  $(\"#modal_artist_name\").val();\r\n");
      out.write("\t    var data = {\r\n");
      out.write("\t    \t\t'message' : message,\r\n");
      out.write("\t    \t\t'order_no' : orderNo,\r\n");
      out.write("\t    \t\t'paint_no' : paintNo,\r\n");
      out.write("\t    \t\t'paint_name' : paintName,\r\n");
      out.write("\t    \t\t'artist_name' : artistName\r\n");
      out.write("\t    \t };\r\n");
      out.write("\t    \t \r\n");
      out.write("\t    \r\n");
      out.write("\t    //위에 벨류 문제없이 잘 받음 확인!!\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\r\n");
      out.write("\r\n");
      out.write("function refundApply(orderNo,paintNo){\r\n");
      out.write("\tvar order_no = orderNo;\r\n");
      out.write("\tvar paint_no = paintNo;\r\n");
      out.write("\t$(\"#refund_order_no\").val(order_no);\r\n");
      out.write("\t$(\"#refund_paint_no\").val(paint_no);\r\n");
      ...
      out.write("\t var orderNo = $(\"#refund_order_no\").val(); //괄호안에 아무것도 없으면 불러오는 것!\r\n");
      out.write("\t var paintNo = $(\"#refund_paint_no\").val();\r\n");
      out.write("\t var selectBank = $(\"#selectBank\").val();\r\n");
      out.write("\t var refundName = $(\"#refundName\").val();\r\n");
      out.write("\t var account = $(\"#account\").val();\r\n");
      out.write("\t var refundReason = $(\"#refundReason\").val();\r\n");
      out.write("\t \r\n");
      out.write("\t var status = $(\"#order_status_\"+orderNo).val();\r\n");
      out.write("\t console.log('test : '+status);\r\n");
      out.write("\t\t\r\n");
      out.write("\t var data = {\r\n");
      out.write("\t\t//문자열로 넣어주면 키가됨!!!!!!!\r\n");
      out.write("\t\t'order_no' : orderNo,\r\n");
      out.write("\t\t'paint_no' : paintNo,\r\n");
      out.write("\t\t'select_bank' : selectBank,\r\n");
      out.write("\t\t'refund_name' : refundName,\r\n");
      out.write("\t\t'account' : account,\r\n");
      out.write("\t\t'refund_reason' : refundReason\r\n");
      out.write("\t };\r\n");
      out.write("\t \r\n");
...
if(loginUser != null){ 
	...
	Member loginUser2 = (Member)session.getAttribute("loginUser");
      ...
      out.write("                    <input type=\"text\"  name=\"searchStatus\" list=\"order_list\" placeholder=\"주문 처리 상태\">\r\n");
      out.write("                    <datalist id=\"order_list\">   \r\n");
      out.write("                        <option value=\"입금 전\">입금전</option>\r\n");
      ...
      out.write("                    <input id=\"calendar1\" type=\"date\" name=\"calendar1\"> ~\r\n");
      out.write("                    <input id=\"calendar2\" type=\"date\" name=\"calendar2\">\r\n");
      out.write("                </div>\r\n");
...
for(int i =0 ; i <list.size();i++){ 
 ...
 if(m.getPaintNo() == a.getPaint_no()) { 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t      \t\t\t<td id=\"artistname\"><label>작가 : </label>");
      out.print(m.getArtistName());
      out.write("<br>\r\n");
      out.write("\t\t\t      \t\t\t<label>작품명 : </label>");
      out.print(m.getPaintName());
      out.write("\r\n");
      out.write("\t\t\t      \t\t\t\t<input type=\"hidden\" id=\"paint_name_");
      out.print(m.getOrderNo());
      out.write("\" value=\"");
      out.print( m.getPaintName() );
      out.write("\" />\r\n");
...
if("환불신청".equals(m.getOrderStatus())){ 
      out.write("\r\n");
      out.write("\t\t\t      \t\t\t\t<a href=\"javascript: alert('이미 신청 완료되었습니다.');\" id=\"refundApplyButton_");
      out.print(gOrderNo );
      out.write("\" class=\"btn btn-secondary btn-sm active\" role=\"button\" aria-pressed=\"true\" style=\"background-color: #fff; color: black;\">반품/취소</a>\t\r\n");
      out.write("\t\t\t      \t\t\t");
}else{ 
      out.write("\r\n");
      out.write("\t\t\t      \t\t\t\t<a href=\"javascript: refundApply('");
      out.print(m.getOrderNo());
      out.write('\'');
      out.write(',');
      out.print(gPaintNo );
      out.write(")\" id=\"refundApplyButton_");
      out.print(gOrderNo );
      ...
      out.print(request.getContextPath() );
      out.write("/Mo.li?currentPage=1'\"> << </button>\r\n");
      out.write("      \r\n");
      out.write("      <!-- 이전 페이지로(<) -->\r\n");
      out.write("      ");
if(currentPage <= 1) {
      out.write("\r\n");
      out.write("      <button class=\"btn btn-secondary\" disabled> < </button>\r\n");
      out.write("      ");
}else{ 
      out.write("\r\n");
      out.write("      <button class=\"btn btn-outline-dark\" onclick=\"location.href='");
      out.print(request.getContextPath() );
      out.write("/Mo.li?currentPage=");
...
if(currentPage == maxPage) {
      ...
      out.write("      \t<div style=\"position: absolute; top : 30px; left:40px;\"><h5><b id=\"modal_title\">작가님에게 메세지를 남겨 보세요!</b></h5></div>\r\n");
      ...
      out.write("          <div id=\"modal_img\" style=\"width: 310px; margin: 0 auto; height: 160px; margin-top: 97px; background-size: cover; background-repeat: no-repeat; background-position: center center;\">\r\n");
      out.write("          \t\r\n");
      out.write("          </div>\r\n");
      out.write("          <textarea id=\"message\" style=\"position:absolute; bottom :60px; width:310px; height:60px; left: 50%; transform: translateX(-50%);\"></textarea>\r\n");
      out.write("          <input type=\"hidden\" id=\"modal_order_no\"><button type=\"button\" onclick=\"insertMessage()\" style=\"position:absolute; left:170px; bottom:20px; border-radius:10px;\"><b>전송</b></button>\r\n");
      out.write("\t\t  <input type=\"hidden\" id=\"modal_paint_no\">\r\n");
      out.write("\t\t  <input type=\"hidden\" id=\"modal_paint_name\">\r\n");
      ...
      out.write("          \t</ul>\r\n");
      out.write("          </div>\r\n");
      out.write("          <button type=\"button\" onclick=\"submit()\" style=\"position:absolute; width:80px; left:115px; bottom:15px; border-radius:10px;\"><b>등록</b></button>\r\n");
      out.write("       \t  <button type=\"button\" id=\"\" style=\"position:absolute; width:80px; right:115px; bottom:15px; border-radius:10px;\"><b>취소</b></button>\r\n");
      out.write("       \t  <input type=\"hidden\" id=\"refund_order_no\">\r\n");
      out.write("       \t  <input type=\"hidden\" id=\"refund_paint_no\">\r\n");
      out.write("      </div>\r\n");
      out.write("   </div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
