 ...
 * Generated at: 2020-05-21 00:54:50 UTC
...
public final class mypage_005forder_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/mypage_user/../common/mypagehead2.jsp", Long.valueOf(1589950761000L));
    _jspx_dependants.put("/views/mypage_user/../common/menubar.jsp", Long.valueOf(1589949742000L));
    _jspx_dependants.put("/views/mypage_user/../common/footer.jsp", Long.valueOf(1589255111000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ArrayList<Attachment> plist = (ArrayList<Attachment>) request.getAttribute("plist");
      ...
      out.write("function confirm2(orderNo){\r\n");
      out.write("\t\t   var status = $(\"#order_status_\"+orderNo).val();\r\n");
      out.write("\t\t   if(status == '배송완료'){\r\n");
      out.write("\t\t\t   if(confirm('수령하시겠습니까?')==true){\r\n");
      out.write("\t\t\t\t   var param = \"order_no=\"+encodeURIComponent(orderNo); //ajax 뒷단 통신. 컴퓨터가 알아먹기 위해 A=A다.\r\n");
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\t\t\t\turl: \"Mo.li\",\r\n");
      out.write("\t\t\t\t\t\tdata: param,\r\n");
      out.write("\t\t\t\t\t\tsuccess: function(ret){ //통신이 완료되었을때 안에거 실행\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#order_status_\"+orderNo).val(\"수령완료\"); //우리는 리로드 해야만 백단 데이터를 가져옴 \r\n");
      out.write("\t\t\t\t\t\t\t$(\"#td_order_status_\"+orderNo).html(\"수령완료\");\r\n");
...
for(Morw m:list){ 
 ...
 if(m.getPaintNo() == a.getPaint_no()) { 
      ...
      out.write("          <textarea id=\"message\" style=\"position:absolute; top :100px; left:40px; width:310px; height:110px;\"></textarea>\r\n");
      out.write("          <button type=\"button\" id=\"submitButton\" onclick=\"submit()\" style=\"position:absolute; left:170px; bottom:20px; border-radius:10px;\"><b>전송</b></button>\r\n");
      ...
      out.write("      <div style=\"width: 400px; height: 440px; background-color: #fff; border-radius: 20px; position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%);\">\r\n");
      ...
      out.write("                   <img src=\"thumbnail_uploadFiles/modal.png\" style=\"width: 100%;\" /></a>\r\n");
      out.write("          <div style=\"border-radius:5px; width:360px; height:320px; background-color:lightgray; position:absolute; top:60px; left:20px; border:1px black;\">\r\n");
      out.write("          \t<ul class= \"refund\" style=\"position:absolute; top:25px; left:20px;\">\r\n");
      out.write("          \t<li><label style=\"margin:14px; width:100px;\">예금주</label><input type=\"text\" style=\"width:180px\">\r\n");
      out.write("          \t<div style=\"font-size:10px; position:absolute; left:126px; margin-top: -6px;\">예금주명은 주문자명과 동일해야합니다.</div></li>\r\n");
      out.write("\t\t    <li><label style=\"margin:14px; width:100px;\">은행선택</label><select style=\"width:180px\">\r\n");
      out.write("\t\t    <option>국민</option>\r\n");
      out.write("\t\t    <option>신한</option>\r\n");
      out.write("\t\t    <option>NH</option>\r\n");
      out.write("\t\t    <option>우리</option>\r\n");
      out.write("\t\t    </select></li>\r\n");
      out.write("\t\t    <li><label style=\"margin:14px; width:100px;\">계좌번호</label><input type=\"text\" style=\"width:180px\">\r\n");
      out.write("\t\t    <div style=\"font-size:10px; position:absolute; left:126px; margin-top: -6px;\">'-'없이 숫자만 입력해주세요.</div></li>\r\n");
      out.write("\t\t    <li><label style=\"margin:14px; width:100px;\">환불사유</label><input type=\"text\" style=\"width:180px\"></li>\r\n");
      out.write("\t\t    <li><label style=\"margin:14px; width:100px;\">비밀번호 확인</label><input type=\"password\" style=\"width:180px\">\r\n");
      out.write("\t\t    <div style=\"font-size:10px; position:absolute; left:126px; margin-top: -6px;\">등록된 비밀번호를 확인합니다.</div></li>\r\n");
      out.write("          \t</ul>\r\n");
      out.write("          </div>\r\n");
      out.write("          <button type=\"button\" id=\"\" onclick=\"submit()\" style=\"position:absolute; width:80px; left:115px; bottom:10px; border-radius:10px;\"><b>등록</b></button>\r\n");
      out.write("       \t  <button type=\"button\" id=\"\" onclick=\"submit()\" style=\"position:absolute; width:80px; right:115px; bottom:10px; border-radius:10px;\"><b>취소</b></button>\r\n");
      out.write("      </div>\r\n");
      out.write("   </div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
