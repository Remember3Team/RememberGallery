 ...
 * Generated at: 2020-05-24 05:52:30 UTC
...
public final class mypage_005fwishlist_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 NumberFormat nf = NumberFormat.getInstance();
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function productBuy(paintName,paintNo,paintPrice){\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t//문제없이 매개변수받아서 찍음\r\n");
      out.write("\tvar paint_name = paintName;\r\n");
      out.write("\tvar paint_no = paintNo;\r\n");
      out.write("\tvar paint_price = paintPrice;\r\n");
      out.write("\t\t\r\n");
      out.write(" \t$(\"#buy_paint_name\").val(paint_name);\r\n");
      out.write(" \t$(\"#buy_paint_no\").val(paint_no);\r\n");
      out.write(" \t$(\"#buy_paint_price\").val(paint_price);\r\n");
      out.write("\t\r\n");
      out.write("\tvar b_paint_name = $(\"#buy_paint_name\").val();\r\n");
      out.write("\tvar b_paint_no = $(\"#buy_paint_no\").val();\r\n");
      out.write("\tvar b_paint_price = $(\"#buy_paint_price\").val();\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("// \t//값 잘들어가서 콘솔에서 b_paint_name이하 잘찍어냄\r\n");
      out.write("\t\r\n");
      out.write("\t var data = {\r\n");
      out.write("\t\t\t\t//문자열로 넣어주면 키가됨!!!!!!!\r\n");
      out.write("\t\t\t\t'paint_name' : b_paint_name,\r\n");
      out.write("\t\t\t\t'paint_no' : b_paint_no,\r\n");
      out.write("\t\t\t\t'paint_price' :  b_paint_price};\r\n");
      out.write("\t\r\n");
      out.write("// \tconsole.log(data);\r\n");
      out.write("\t $.ajax({\r\n");
      out.write("\t\t  type: \"POST\",\r\n");
      out.write("\t\t  url: \"Buy.po\",\r\n");
      out.write("\t\t  data: data,\r\n");
...
for(Morw m:list){
 ...
 if(m.getPaintNo() == a.getPaint_no()) { 
      ...
      out.write("\" />\r\n");
      out.write("\t\t\t      \t\t\t</td>\r\n");
      out.write("\t\t\t      \t\t\t<td><a href=\"javascript: productBuy('");
      out.print(m.getPaintName());
      out.write('\'');
      out.write(',');
      out.write('\'');
      ...
      out.write('\'');
      out.print(m.getPaintPrice() );
      out.write("')\" id=\"productBuy\" class=\"btn btn-secondary btn-sm active\" role=\"button\" aria-pressed=\"true\">주문하기</a></td>\r\n");
      out.write("\t\t\t    \t\t\t<input type=\"hidden\" id=\"buy_paint_name\">\r\n");
      out.write("\t\t\t    \t\t\t<input type=\"hidden\" id=\"buy_paint_no\">\r\n");
      out.write("\t\t\t    \t\t\t<input type=\"hidden\" id=\"buy_paint_price\">\r\n");
      out.write("\t\t\t    \t\t</tr>\r\n");
      out.write("\t\t\t    \t\t");
} 
      out.write("\r\n");
      ...
      out.write("      <button type=\"submit\" class=\"btn btn-dark\" style=\"width:100px; float:right;\"onclick=\"javascript: deleteBasket();\">선택상품 삭제</button>\r\n");
