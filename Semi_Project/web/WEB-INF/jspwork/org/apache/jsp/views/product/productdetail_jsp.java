...
<<<<<<< HEAD
 * Generated at: 2020-05-26 07:24:57 UTC
=======
<<<<<<< HEAD
 * Generated at: 2020-05-25 00:19:26 UTC
=======
 * Generated at: 2020-05-25 08:49:45 UTC
...
<<<<<<< HEAD
    _jspx_dependants.put("/views/product/../common/menubar.jsp", Long.valueOf(1590332147839L));
...
for(int i =0; i< alist.size();i++){
 ...
 for(int i= qna.size()-1; i>=0; i--){ 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width = \"350px\" class = \"question-box\">");
...
if(qna.get(i).getPq_no() == qna2.get(j).getPq_no()){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr style=\"vertical-align : middle; text-align: center;\" class=\"answertable\">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>답변:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width = \"350px\" class = \"question-box\">");
      ...
      out.write("\t\t\t\t\t\t//\tvar $tr = $(\"<tr>\");\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tvar $test1 = $(\"<td>답변 : \");\r\n");
      out.write("\t\t\t\t\t\t\tvar $contentTd =$(\"<td>\").text(data.panswer).css(\"width\",\"350px\");\r\n");
      out.write("\t\t\t\t\t\t\tvar $dateTd = $(\"<td>\").text(data.pq_date)\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
