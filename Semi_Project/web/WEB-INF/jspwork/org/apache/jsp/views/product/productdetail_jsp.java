 ...
 * Generated at: 2020-05-19 05:26:15 UTC
...
public final class productdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/product/../common/menubar.jsp", Long.valueOf(1589778658029L));
...
for(int i =0; i< alist.size();i++){
 ...
 for(int i =0;i < sizelist.size();i++) {
      ...
      out.write("      </table>  \t \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("      <hr style=\"margin: 1;\" color=\"black\" width=\"554px\">\r\n");
      out.write("      <span style=\"text-align: center; width: 100px; font-size: 35px; text-decoration: none !important; border-bottom: dotted 0px !important; color: black !important;\">");
